  ...
  panels: [
    {
      ...
      element: (
        <Layout layout gap={28}>
          ...
          <Card title={'Registry'} body={'stores images'} color={c.violet} />
          <Card
            title={'Runtime'}
            body={'prepares and starts'}
            color={c.amber}
          />
    ...
    },
    {
      ...
      element: (
        <Layout layout gap={70} alignItems={'center'}>
          ...
          <Card
            title={'filesystem layers'}
            body={'base · packages · runtime deps · app files'}
          />
          <Card
            title={'config / metadata'}
            body={'default command · environment'}
            color={c.amber}
          />
        </Layout>
      ),
    },
    {
      ...
      element: (
        <Layout layout gap={80} alignItems={'center'}>
          <ImageBox label={'image artifact'} />
          <RegistryBox />
          <Card
            title={'no process pulse'}
            body={
              'a registry stores and distributes; it does not run containers'
            }
            color={c.violet}
            width={420}
          />
