...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <Layout ref={main} layout direction={'column'} gap={44} alignItems={'center'} justifyContent={'center'} width={'100%'} height={'100%'} padding={70} opacity={0}>
      ...
      <Layout layout direction={'column'} gap={34} alignItems={'center'}><ContainerInstance label={'process / process group'} /><KernelLayer /><Txt text={'container = process with prepared boundaries'} fontSize={38} fill={c.cyan} /></Layout>
    </Layout>,
  );
