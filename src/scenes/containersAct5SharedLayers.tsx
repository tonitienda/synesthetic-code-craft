...
export default makeContainersScene({
  ...
  sub: 'shared lower layers, private top layers',
  panels: [
    {
      hold: 15,
      element: (
        <Layout layout direction={'column'} gap={28} alignItems={'center'}>
          <Layout layout gap={180}>
    ...
    },
    {
      ...
      element: (
        <Layout layout gap={70} alignItems={'center'}>
          <LayerStack writable={'Writable A'} />
          <LayerStack />
          <LayerStack writable={'Writable B'} />
        </Layout>
      ),
    },
    {
      ...
      element: (
        <Txt
          text={
            'Both containers read the same lower layers; neither changes the image.'
          }
          fontSize={36}
          fill={c.muted}
        />
