# Git local-first version control — content status

This folder contains the Markdown-first source for the `git-local-first-version-control` video.
...
Review `03-beats.md`. When the beat sequence feels complete and aligned with the treatment, mark it `ready` before creating `04-narration.md`.
