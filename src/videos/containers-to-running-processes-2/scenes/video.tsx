...
export default makeScene2D(function* (view) {
  ...
  yield* all(
    ...
    // v2 is choreography-only: the narration audio and its timing are added and
    // synced separately, so the visual beats are driven purely by the scene
    // holds below and never fight a parallel narration track.
    playMovie(world),
  )
